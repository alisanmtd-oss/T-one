...
The public repository contains a sanitized Python community core, public knowledge packs, and an installable offline desktop demo. The Chinese desktop demo now includes a truthful capability market organized by Agent, Skill, MCP, and CLI.
